# 👋 Hi, I'm Leonardo Gabriel Puebla

<div align="center">

### Full Stack Developer · Frontend Specialist · DDD Enthusiast
...
const leonardo = {
  ...
  experience: "3+ years",
  focus: ["React", "Svelte", "Node.js", "DDD"],
  currently: "Building CoNeko Marketplace from scratch",
  location: "Mendoza, Argentina 🇦🇷",
  passions: ["Legacy modernization", "Clean architecture", "Performance optimization"]
};
```

**Software developer focused on building maintainable, scalable systems.**  
I value clean code, clear requirements, and pragmatic solutions.
...
![Chakra_UI](https://img.shields.io/badge/Chakra_UI-319795?style=for-the-badge&logo=chakra-ui&logoColor=white)
![SASS](https://img.shields.io/badge/SASS-CC6699?style=for-the-badge&logo=sass&logoColor=white)
![AG_Grid](https://img.shields.io/badge/AG_Grid-00A3E0?style=for-the-badge&logo=&logoColor=white)
...
![PouchDB](https://img.shields.io/badge/PouchDB-32A6DC?style=for-the-badge&logo=pouchdb&logoColor=white)
...
![Testing_Library](https://img.shields.io/badge/Testing_Library-E33332?style=for-the-badge&logo=testing-library&logoColor=white)
...
- 🏗️ **Currently building:** CoNeko Marketplace with DDD architecture
- ⚡ **Performance optimization:** Reduced response time from 800ms to 450ms
- 📚 **Documentation:** 50% faster team onboarding through clear docs
- 🔧 **Legacy systems:** Specialized in modernizing complex codebases
- 💯 **Problem solver:** 100% critical issues resolved in <24h
